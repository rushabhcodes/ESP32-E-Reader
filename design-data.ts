...
export const chips: ChipSpec[] = [
	...
	},
	{
		...
		pins: Array.from({ length: 20 }, (_, i) => `${i + 1}`),
		noConnect: ["10", "16"],
		section: "battery_usb",
...
export const nets: Record<string, string[]> = {
	...
	USB_CC1: [endpoint("J1", "15"), endpoint("R7", "1")],
	USB_CC2: [endpoint("J1", "9"), endpoint("R8", "1")],
